public class Main {
    public static void main(String args[]){
        ...
        */
        ...
        System.out.println ((1)-8+ (double)1 +(3));
        System.out.println ((1)-8+(double)4);
        System.out.println (1-(double)4);
        ...
        System.out.println(((10) * (double)0.8509035245341184+ 2) - Math.pow(Math.sqrt(25), 3));
        System.out.println(((10) * (double)0.8509035245341184+ 2) - Math.pow(5,3));
        System.out.println(((double)8.509035245341184+ 2) - Math.pow(5,3));
        System.out.println(((double)10.509035245341184) - Math.pow(5,3));
        System.out.println(((double)10.509035245341184) - (double)125);
        System.out.println((double)-114.49096475465882);
